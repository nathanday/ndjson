...
- (void)willLoad
{
	...
	[self addTest:[TestCoreDataItem testStringWithName:@"Core Data with Type Conversion" jsonString:kTestJSONString3 expectedResult:[self creatExpectedOneValueInCoreDataController:self.coreDataController] inCoreDataController:self.coreDataController]];
	[super willLoad];
}
