...
- (void)willLoad
{
	...
	[self addName:@"Zero Length Key" jsonString:@"{\"\":{\"message\":\"lib comment is not found\",\"errCode\":1,\"result\":null,\"lib\":\"\"}}" expectedResult:[NSDictionary dictionaryWithObjectsAndKeys:[NSDictionary dictionaryWithObjectsAndKeys:@"lib comment is not found", @"message",INTNUM(1), @"errCode", [NSNull null], @"result", @"", @"lib", nil], @"", nil]];
	...
	[self addName:@"UnBalanced Nested Object" jsonString:@"{\"one\":1,\"two\":2},\"three\":3,\"four\":4}" expectedResult:[NSDictionary dictionaryWithObjectsAndKeys:INTNUM(1),@"one",INTNUM(2),@"two",nil]];
